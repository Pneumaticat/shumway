    ...
    (function (AVM1) {
        ...
        (function (Lib) {
            ...
            var AVM1Utils = (function () {
                ...
                AVM1Utils.resolveLevelOrTarget = function (context, target) {
                    return typeof target === 'number' ? context.resolveLevel(target) : context.resolveTarget(target);
                };
                return AVM1Utils;
            })();
            ...
            function initializeAVM1Object(as3Object, context, placeObjectTag) {
                ...
                for (var j = 0; j < events.length; j++) {
                    ...
                    for (var eventFlag in ClipEventMappings) {
                        ...
                        if (!eventName) {
                            Shumway.Debug.warning(AVM1ClipEvents[eventFlag] + ' ClipEvent not implemented');
                            continue;
                        }
        ...
        (function (Lib) {
            ...
            var AVM1MovieClip = (function (_super) {
                ...
                AVM1MovieClip.prototype.swapDepths = function (target) {
                    var target_mc = Lib.AVM1Utils.resolveLevelOrTarget(this.context, target);
                    if (!target_mc) {
        ...
        (function (Lib) {
            ...
            var AVM1MovieClipLoader = (function (_super) {
                ...
                AVM1MovieClipLoader.prototype.loadClip = function (url, target) {
                    this._target = Lib.AVM1Utils.resolveLevelOrTarget(this.context, target);
                    if (!this._target) {
                ...
                AVM1MovieClipLoader.prototype.unloadClip = function (target) {
                    var nativeTarget = Lib.AVM1Utils.resolveLevelOrTarget(this.context, target);
                    if (!nativeTarget) {
                        return false; // target was not found -- doing nothing
                    }
